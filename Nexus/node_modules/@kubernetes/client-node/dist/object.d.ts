import { Configuration, RequestContext, ResponseContext, V1APIResource, V1APIResourceList, V1DeleteOptions, V1Status } from '@kubernetes/client-node/dist/api
...
import { PatchStrategy } from '@kubernetes/client-node/dist/patch
