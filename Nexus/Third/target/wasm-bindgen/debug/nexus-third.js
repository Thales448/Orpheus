...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbindgen_cast_0000000000000003: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { dtor_idx: 489, function: Function { arguments: [], shim_idx: 494, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('nexus-third_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
